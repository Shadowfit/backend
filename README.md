...
| `PATCH` | `/admin/exercises/{exerciseId}/analysis-support` | AI 분석 활성화 여부 전환 — 기준 좌표 0건이면 400 거부(필요조건일 뿐, ai-server는 현재 종목 무관 squat 고정 분석) |
