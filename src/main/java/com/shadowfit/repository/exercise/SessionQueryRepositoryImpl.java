...
public class SessionQueryRepositoryImpl implements SessionQueryRepository {
     ...
     *
     * <p>✅ <b>2026-08-07 확정 — 이 메서드는 남는다.</b> 관리자 프론트가
     * <b>별도 웹 + 페이지 번호</b>로 정해져({@code admin-page-scope.md} §5-1)
     * "무한 스크롤이면 안 부르면 된다"는 갈래가 사라졌다. 총건수는 감수한 비용이 아니라
     * <b>페이지 번호 UI 를 그리기 위한 요구사항</b>이다.
     *
